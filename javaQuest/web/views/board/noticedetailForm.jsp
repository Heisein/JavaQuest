...
<body>
	...
	<h1 class="h1" style="font-weight:bold">공지사항 상세보기</h1>
	<div class="tableArea" >
		...
		<table>
			...
			<tr id="notRemoveThis">
				<td>
					...
					<button id="addReply2" type="button" onclick="location.href='<%= request.getContextPath() %>/selectqaa.no'">목록으로 돌아가기</button>
				</td>	
			</tr>
		</table>
		<div>
	...
	<script>
		...
		$("#updatenotice").click(function(){
			location.href="<%= request.getContextPath() %>/insertQaa.bo?num=<%= n.getBid() %>";
		});
