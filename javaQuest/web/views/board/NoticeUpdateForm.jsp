...
<body>
	...
	<form action="<%= request.getContextPath() %>/insertQaa.bo" align="center" method="get">
		<table id="tableArea" width="700" align="center">
			...
			<tr>
				<td>제목</td>
				<td><input type="text" size="70" id="title" name ="title" value="<%= n.getBtitle() %>"></td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea cols="70" rows="20" style="resize:none" size="75" id="content" name="content" value="<%= n.getBcontext() %>" ></textarea></td>
			</tr>
			<tr>
				<td>파일첨부</td>
