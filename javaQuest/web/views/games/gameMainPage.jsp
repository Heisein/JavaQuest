...
<body>
	...
	<!-- conArea -->
	<div class="btn-Area">
		<button class="game-start" onclick="location.href='/jqt/views/games/selectedGamePage.jsp'">게임하기</button>
	</div>
	...
	function changeContent(str){
		switch(str){
			case "select" : 
				...
				$(".game-start").attr("onclick", "location.href='/jqt/views/games/selectedGamePage.jsp'");
				break;
			case "count" : 
				$("#con-title").text("카운트"); 
			...
			case "battle" : 
				...
				$(".game-start").attr("onclick", "location.href='/jqt/views/games/Oxquiz.jsp'");
				break;
			case "dual" : 
				$("#con-title").text("코딩대결"); 
...
<body>
	...
	<!-- leftBox -->
		...
		<!-- conArea -->
		<div class="btn-Area">
			<button class="game-start" onclick="location.href='/jqt/views/games/selectedGamePage.jsp'" style="display: none;">게임하기</button>
		</div>
