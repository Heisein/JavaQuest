...
<style>
	html, body {
		...
		padding:0px;
		margin:0px;
		background-image:url("<%= request.getContextPath() %>/image/backvil1.jpg");
...
<body>
	<div class='left-box'>
			<div style="padding:0% 2% 2% 2%;"><p style="float:left;width:auto;" contenteditable="true" class="noEnter">문제 제목을 적어주세요.</p><div style="background-color:purple;width:40px;text-align:center;padding:5px;color:#ffffff;font-size:12px;border-radius:5px;font-weight:Bold;float:left;margin-top:13px;margin-left:5px;">Level </div></div>
			<div id="left_bottom" contenteditable="true">이곳에 문제 내용을 적어주세요.</div>
		</div>
		<div class='right-box'>
		
			<div style="color:#ffffff;width:100%;border-bottom:1px solid black;padding:0% 1% 0.5% 1%;"><p style="">에디터</p> </div>
			<form action="<%= request.getContextPath() %>/addQuest.qu" method="post" id="comform">
...
public class HereWeGo {
	public void runMethod(){
		...
		<div class='right-box-bottom'>
			...
			<label style="color:white;" contenteditable="true" class="noEnter">
이곳에 문제의 답을 적어주세요.
			</label>
		</div>
